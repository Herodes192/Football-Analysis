...
class FootballAPIService:
    ...
    def _get_current_season(self) -> int:
        """Get the correct season year for API calls - Use 2024 for now"""
        # Hard-coded to 2024 since 2025-2026 season data may not be available yet
        # The 2024-2025 season is represented as 2024 in the API
        return 2024
